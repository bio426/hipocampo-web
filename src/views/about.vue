<template>
	<div id="about">
		...
		<div class="container">
			<h1>¿QUIÉNES SOMOS?</h1>
			<p>
				Hipocampo Editores se fundó en noviembre de 1997. Es un sello que nació
				en olor a poesía. Hipocampo Editores ha publicado a diversidad de voces,
				escritoras y escritores, de casi todas las regiones del Perú.
			</p>
			<p>
				Nuestro catálogo también contiene cuentos, novelas y ensayos. Como
				gestores culturales tenemos la difícil tarea de formar personas que
				aviven el fuego de cada día con la lectura y que apaguen, cual paradoja,
				esas otras terribles violencias humanas.
			</p>
			<hr />
			<div class="logoInfo">
				...
				<div class="logoDescription">
					...
					<p>
						...
						del bar Queirolo del centro de Lima en 1997.
					</p>
				</div>
			</div>
			<hr />
			<h2>EL ORIGEN DEL HIPOCAMPO</h2>
			...
			<div class="descriptionGrid">
				...
				<p>
					...
					Las Rejas debido al armazón de hierro forjado que cubría la entrada. O
					...
					narrador José Benavides Gastelú, el fotógrafo Jorge Verástegui, el
					pintor Carlos Ostolaza y la musa Karin Trencitas -que modeló para la
					carátula- pusieron lo suyo en el logro de la edición. POSTERIORMENTE
					...
					Ruíz-Rosas Samohod. Sendas presentaciones en la galería Borka’s de
					Miraflores y en El Averno -inaugurado a propósito de este acto-
					lanzaron asimismo el flamante sello Hipocampo Editores.
				</p>
				<p>
					Muchos libros han navegado ya -en estos casi diez años- sobre las
					aguas cristalinas de la edición. Y han llegado a buen puerto. No
					...
					de su aventura, me complace escribir estas líneas para su reciente
					...
					Gambarini, Josemari Recalde, Edgar Kilowat Barraza, Edwin Zcuela Núñez
					José Antonio Pocho Ríos, Juan Ramírez Ruíz, nuestros muertos
					...
					guardo la mejor memoria, una que se parece mucho a la solidaridad, a
					la verdadera camaradería, igual a la canción que se entona a la
					medianoche para espantar la angustia y devolvernos a la dimensión
...
<style src="@/assets/styles/pages/about.scss"></style>
